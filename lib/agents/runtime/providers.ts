...
export const runtimeProviders: Record<RuntimeProvider, ProviderDescriptor> = {
  openai: { id: "openai", label: "OpenAI", secretEnvironmentVariable: "OPENAI_API_KEY", defaultModelAlias: "openai-balanced", simulatedInputUsdPerMillion: 2, simulatedOutputUsdPerMillion: 8 },

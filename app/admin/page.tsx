...
type AdminView = "Dashboard" | "Users" | "Wallet & Transactions" | "Withdrawals" | "KYC Verification" | "Fraud & Risk" | "Ad Networks" | "Surveys" | "App Install Offers" | "Games" | "Shop & Earn" | "Referrals";
            ...
            <div className="mb-5" key={group.label ?? "main"}>
              ...
              <div className="space-y-1">
                {group.items.map((item) => {
                  const enabled = item.label === "Dashboard" || item.label === "Users" || item.label === "Wallet & Transactions" || item.label === "Withdrawals" || item.label === "KYC Verification" || item.label === "Fraud & Risk" || item.label === "Ad Networks" || item.label === "Surveys" || item.label === "App Install Offers" || item.label === "Games" || item.label === "Shop & Earn" || item.label === "Referrals";

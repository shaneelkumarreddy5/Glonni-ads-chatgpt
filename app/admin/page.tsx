...
function AgentWorkspace({ agent, onBack, action }: { agent: AgentDirectoryItem; onBack: () => void; action: (message: string) => void }) {
  ...
  return <>
    ...
    : tab === "Business Dashboard" ? <BusinessDashboard action={action}/>
    : tab === "Revenue Analytics" ? <RevenueAnalytics action={action}/>
    : tab === "User Analytics" ? <UserAnalytics action={action}/>
    ...
    : tab === "Automations" && isDataAnalystAgent ? <AnalystAutomations action={action}/>
    : tab === "Activity History" && isDataAnalystAgent ? <AnalystActivity/>
    : tab === "Connections" && isDataAnalystAgent ? <AnalystConnections action={action}/>
